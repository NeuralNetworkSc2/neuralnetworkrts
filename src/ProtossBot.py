...
Dif = {}
Dif['VeryEasy'] = Difficulty.VeryEasy
Dif['Easy'] = Difficulty.Easy
Dif['Medium'] = Difficulty.Medium
Dif['MediumHard'] = Difficulty.MediumHard
Dif['Harder'] = Difficulty.Harder
Dif['VeryHard'] = Difficulty.VeryHard
Rac = {}
Rac['Terran'] = Race.Terran
Rac['Zerg'] = Race.Zerg
Rac['Protoss'] = Race.Protoss
args = sys.argv

run_game(
    maps.get(args[1]), [
    Bot(Race.Protoss, ProtossBot()),
    Computer(Rac[args[3]], Dif[args[2]])
    ], realtime=False
)
